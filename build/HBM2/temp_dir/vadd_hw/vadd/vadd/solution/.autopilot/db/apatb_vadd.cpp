...
// wrapc file define:
#define AUTOTB_TVIN_gmem2 "../tv/cdatafile/c.vadd.autotvin_gmem2.dat"
#define AUTOTB_TVOUT_gmem2 "../tv/cdatafile/c.vadd.autotvout_gmem2.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_gmem2 "../tv/rtldatafile/rtl.vadd.autotvout_gmem2.dat"
// tvout file define:
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          if (i > 0) {{
            ...
            ((int*)__xlx_apatb_param_out)[j] = gmem2_pc_buffer[i].to_int64();
          }}}
        } // end transaction
      } // end file is good
