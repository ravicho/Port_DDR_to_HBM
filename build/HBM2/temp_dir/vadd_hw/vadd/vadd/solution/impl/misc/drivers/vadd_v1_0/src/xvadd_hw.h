...
#define XVADD_CONTROL_ADDR_NUM_TIMES_DATA 0x3c
#define XVADD_CONTROL_BITS_NUM_TIMES_DATA 32
#define XVADD_CONTROL_ADDR_ADDRANDOM_DATA 0x44
#define XVADD_CONTROL_BITS_ADDRANDOM_DATA 1
