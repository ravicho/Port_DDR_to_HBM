...
void XVadd_Set_num_times(XVadd *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XVadd_WriteReg(InstancePtr->Control_BaseAddress, XVADD_CONTROL_ADDR_NUM_TIMES_DATA, Data);
}

u32 XVadd_Get_num_times(XVadd *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XVadd_ReadReg(InstancePtr->Control_BaseAddress, XVADD_CONTROL_ADDR_NUM_TIMES_DATA);
    return Data;
}

void XVadd_Set_addRandom(XVadd *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XVadd_WriteReg(InstancePtr->Control_BaseAddress, XVADD_CONTROL_ADDR_ADDRANDOM_DATA, Data);
}

u32 XVadd_Get_addRandom(XVadd *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XVadd_ReadReg(InstancePtr->Control_BaseAddress, XVADD_CONTROL_ADDR_ADDRANDOM_DATA);
    return Data;
}
